export const ALT_TEXT = {
  logo: "Stylized letter 'W' followed by a period, used as a logo.",
  heroImage: 'Abstract colorful blocks resembling LEGO pieces.',
  retroPC: 'Retro PC',
  topLaptops: 'Top laptops of 2022',
  gamingGrowth: 'Floating game controller above a hand',
};
